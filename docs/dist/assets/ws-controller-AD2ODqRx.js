...
reactIs_production_min$1.isValidElementType = function(a2) {
  return "string" === typeof a2 || "function" === typeof a2 || a2 === e$1 || a2 === m$3 || a2 === g$2 || a2 === f$2 || a2 === p$2 || a2 === q$2 || "object" === typeof a2 && null !== a2 && (a2.$$typeof === t$1 || a2.$$typeof === r$1 || a2.$$typeof === h$2 || a2.$$typeof === k$2 || a2.$$typeof === n$1 || a2.$$typeof === w$2 || a2.$$typeof === x$1 || a2.$$typeof === y$1 || a2.$$typeof === v$3);
};
...
reactIs_production_min.isValidElementType = function(a2) {
  return "string" === typeof a2 || "function" === typeof a2 || a2 === d || a2 === f$1 || a2 === e || a2 === m$2 || a2 === n || a2 === t || "object" === typeof a2 && null !== a2 && (a2.$$typeof === q$1 || a2.$$typeof === p$1 || a2.$$typeof === g$1 || a2.$$typeof === h$1 || a2.$$typeof === l || a2.$$typeof === u || void 0 !== a2.getModuleId) ? true : false;
};
...
const p = (r2) => {
  ...
  return false;
}, h = (...r2) => r2.reduce((t2, e2) => {
  if (Array.isArray(e2))
    throw new TypeError("Arguments provided to ts-deepmerge must be objects, not arrays.");
  return Object.keys(e2).forEach((s) => {
    ["__proto__", "constructor", "prototype"].includes(s) || (Array.isArray(t2[s]) && Array.isArray(e2[s]) ? t2[s] = h.options.mergeArrays ? h.options.uniqueArrayItems ? Array.from(new Set(t2[s].concat(e2[s]))) : [...t2[s], ...e2[s]] : e2[s] : p(t2[s]) && p(e2[s]) ? t2[s] = h(t2[s], e2[s]) : t2[s] = e2[s] === void 0 ? h.options.allowUndefinedOverrides ? e2[s] : t2[s] : e2[s]);
  }), t2;
}, {}), m = {
...
h.options = m;
h.withOptions = (r2, ...t2) => {
  h.options = Object.assign(Object.assign({}, m), r2);
  const e2 = h(...t2);
  return h.options = m, e2;
};
...
var c = /* @__PURE__ */ ((r2) => (r2.closed = "closed", r2.connecting = "connecting", r2.connected = "connected", r2.closing = "closing", r2))(c || {});
class T {
  constructor(t2) {
...
class b {
  ...
  setOptions(t2 = {}) {
    this.options = h(this.options, t2);
  }
  send() {
...
class w {
  constructor(t2) {
    this.options = {
      ...
      resovle: null,
      reject: null
    }, this.pause = false, this.connectingTimer = null, this.closingTimer = null, this.heartbeat = new b({ wsContoller: this }), this.events = new T(["message", "log", "status"]), this.setOptions(t2);
  }
  get connectStatus() {
  ...
  setOptions({ wsOptions: t2, heartbeatOptions: e2 }) {
    this.options = h(this.options, t2 ?? {}), this.heartbeat.setOptions(e2);
  }
  _setSocketInstance(t2) {
    const e2 = this;
    a = new WebSocket(t2), a.onopen = function(s) {
      var n2, i, o, u2;
      if (e2.connectStatus == c.connecting) {
        e2.connectStatus = c.connected;
      ...
      var n2, i;
      if (e2.connectStatus == c.closing) {
        e2.connectStatus = c.closed;
      ...
      if (e2.connectStatus == c.connecting) {
        ...
        e2.connectStatus == c.closing && (e2.connectStatus = c.connecting, (u2 = (o = e2.closingCb) == null ? void 0 : o.reject) == null || u2.call(o, { success: false, message: `关闭失败: onerror:${s}` }), e2._clearClose());
  ...
  async _wsConnect(t2) {
    return new Promise((e2, s) => {
      try {
        ...
        this.connectingCb.resovle = e2, this.connectingCb.reject = s, this.connectStatus = c.connecting, this._setSocketInstance(n2.address), this.connectingTimer = setTimeout(() => {
  ...
  async _wsClose() {
    return new Promise((t2, e2) => {
      ...
      this.closingCb.resovle = t2, this.closingCb.reject = e2, this.connectStatus = c.closing, a == null || a.close(), this.closingTimer = setTimeout(() => {
...
const WsConfig = () => {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsx(Container$6, { children: /* @__PURE__ */ jsxRuntimeExports.jsx(CardItem, { title: "Server", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "input-group", children: [
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx(
      Button$1,
      {
        disabled: (wsController == null ? void 0 : wsController.connectStatus) !== c.closed,
        onClick: () => connect(),
        variant: "contained",
        size: "small",
        color: "success",
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx(
      Button$1,
      {
        disabled: (wsController == null ? void 0 : wsController.connectStatus) !== c.connected,
...
const WsStatus = () => {
  ...
  const [socketStatus, setSocketStatus] = reactExports.useState(c.closed);
  useOnMount(() => {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsx(Container$5, { children: /* @__PURE__ */ jsxRuntimeExports.jsx(CardItem, { title: "connect state", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "status-group", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: classNames("status", { "status--closed": socketStatus == c.closed }) }),
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: classNames("status", { "status--processing": [c.connecting, c.closing].includes(socketStatus) }) }),
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: classNames("status", { "status--connected": socketStatus == c.connected }) }),
...
const IntervalSend = ({ setMessage }) => {
  ...
  useOnMount(() => {
    loopLoigc = loopFunc(async () => {
      var _a, _b;
      if ((wsController == null ? void 0 : wsController.connectStatus) !== c.connected) {
        loopLoigc.stop();
        setOpen(false);
        return;
      }
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsx(Container$4, { children: /* @__PURE__ */ jsxRuntimeExports.jsx(CardItem, { title: "Interval send", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "send-group", children: [
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "input-content", children: [
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsx(Button$1, { disabled: (wsController == null ? void 0 : wsController.connectStatus) !== c.connected, style: { display: !open ? "block" : "none" }, onClick: () => startLoop(), variant: "contained", size: "small", color: "success", disableElevation: true, children: "start" }),
      /* @__PURE__ */ jsxRuntimeExports.jsx(Button$1, { disabled: (wsController == null ? void 0 : wsController.connectStatus) !== c.connected, style: { display: !open ? "none" : "block" }, onClick: () => {
        loopLoigc.stop();
        setOpen(false);
  ...
  !function(t2, e2) {
    ...
    var _2 = function() {
      ...
      return m3.parse = function(t3) {
        ...
        var n3, o2 = b2.p(t3), f3 = "set" + (this.$u ? "UTC" : ""), l3 = (n3 = {}, n3[a2] = f3 + "Date", n3[d2] = f3 + "Date", n3[c2] = f3 + "Month", n3[h2] = f3 + "FullYear", n3[u2] = f3 + "Hours", n3[s] = f3 + "Minutes", n3[i] = f3 + "Seconds", n3[r2] = f3 + "Milliseconds", n3)[o2], $3 = o2 === a2 ? this.$D + (e3 - this.$W) : e3;
        if (o2 === c2 || o2 === h2) {
        ...
        var r3 = t3 || "YYYY-MM-DDTHH:mm:ssZ", i2 = b2.z(this), s2 = this.$H, u3 = this.$m, a3 = this.$M, o2 = n3.weekdays, c3 = n3.months, f3 = n3.meridiem, h3 = function(t4, n4, i3, s3) {
...
`;
function App() {
  const wsContoller = useReactive(new w({
    heartbeatOptions: {
